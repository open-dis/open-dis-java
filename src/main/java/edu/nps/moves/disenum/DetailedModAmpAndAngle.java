 ...
 * Use as DetailedModAmpAndAngle.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public DetailedModAmpAndAngle lookup[] = new DetailedModAmpAndAngle[2];

static private HashMap<Integer, DetailedModAmpAndAngle>enumerations = new HashMap<Integer, DetailedModAmpAndAngle>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    DetailedModAmpAndAngle val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public DetailedModAmpAndAngle getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    DetailedModAmpAndAngle val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration DetailedModAmpAndAngle");
      return val;
}

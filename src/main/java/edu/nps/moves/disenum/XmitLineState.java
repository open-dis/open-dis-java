...
/** Enumeration values for XmitLineState
 ...
 * Use as XmitLineState.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public XmitLineState lookup[] = new XmitLineState[4];

static private HashMap<Integer, XmitLineState>enumerations = new HashMap<Integer, XmitLineState>();

/* initialize the array and hash table at class load time */
static 
{
    for(XmitLineState anEnum:XmitLineState.values())
    {
...
/** Constructor */
XmitLineState(int value, String description)
{
    this.value = value;
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    XmitLineState val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public XmitLineState getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    XmitLineState val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration XmitLineState");
      return val;
}

...
public class MineEntityIdentifier extends Object implements Serializable
{
   ...
   private long pk_MineEntityIdentifier;
...
public long getPk_MineEntityIdentifier()
{
   return pk_MineEntityIdentifier;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_MineEntityIdentifier(long pKeyName)
{
   this.pk_MineEntityIdentifier = pKeyName;
}

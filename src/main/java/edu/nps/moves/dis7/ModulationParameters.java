...
public class ModulationParameters extends Object implements Serializable
{
   ...
   private long pk_ModulationParameters;
...
public long getPk_ModulationParameters()
{
   return pk_ModulationParameters;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_ModulationParameters(long pKeyName)
{
   this.pk_ModulationParameters = pKeyName;
}

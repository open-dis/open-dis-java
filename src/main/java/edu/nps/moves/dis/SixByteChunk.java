...
public long getPk_SixByteChunk()
{
   return pk_SixByteChunk;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_SixByteChunk(long pKeyName)
{
   this.pk_SixByteChunk = pKeyName;
}
...
@Override
 ...
 public boolean equalsImpl(Object obj)
 {
    ...
    if(!(obj instanceof SixByteChunk))
        return false;

     final SixByteChunk rhs = (SixByteChunk)obj;

 ...
 * Use as Aircraft.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public Aircraft lookup[] = new Aircraft[101];

static private HashMap<Integer, Aircraft>enumerations = new HashMap<Integer, Aircraft>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    Aircraft val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public Aircraft getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    Aircraft val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration Aircraft");
      return val;
}

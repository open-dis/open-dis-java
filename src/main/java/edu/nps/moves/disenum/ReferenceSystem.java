 ...
 * Use as ReferenceSystem.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public ReferenceSystem lookup[] = new ReferenceSystem[3];

static private HashMap<Integer, ReferenceSystem>enumerations = new HashMap<Integer, ReferenceSystem>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    ReferenceSystem val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public ReferenceSystem getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    ReferenceSystem val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration ReferenceSystem");
      return val;
}

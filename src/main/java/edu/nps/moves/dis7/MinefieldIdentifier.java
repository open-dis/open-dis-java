...
public class MinefieldIdentifier extends Object implements Serializable
{
   ...
   private long pk_MinefieldIdentifier;
...
public long getPk_MinefieldIdentifier()
{
   return pk_MinefieldIdentifier;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_MinefieldIdentifier(long pKeyName)
{
   this.pk_MinefieldIdentifier = pKeyName;
}

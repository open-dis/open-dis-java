 ...
 * Use as MunitionDomain.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public MunitionDomain lookup[] = new MunitionDomain[13];

static private HashMap<Integer, MunitionDomain>enumerations = new HashMap<Integer, MunitionDomain>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    MunitionDomain val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public MunitionDomain getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    MunitionDomain val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration MunitionDomain");
      return val;
}

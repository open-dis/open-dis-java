...
public long getPk_TwoByteChunk()
{
   return pk_TwoByteChunk;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_TwoByteChunk(long pKeyName)
{
   this.pk_TwoByteChunk = pKeyName;
}
...
@Override
 ...
 public boolean equalsImpl(Object obj)
 {
    ...
    if(!(obj instanceof TwoByteChunk))
     ...
     final TwoByteChunk rhs = (TwoByteChunk)obj;

...
public class DirectedEnergyTargetEnergyDeposition extends Object implements Serializable
{
   ...
   private long pk_DirectedEnergyTargetEnergyDeposition;
...
public long getPk_DirectedEnergyTargetEnergyDeposition()
{
   return pk_DirectedEnergyTargetEnergyDeposition;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_DirectedEnergyTargetEnergyDeposition(long pKeyName)
{
   this.pk_DirectedEnergyTargetEnergyDeposition = pKeyName;
}

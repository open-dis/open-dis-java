...
public class CommunicationsNodeID extends Object implements Serializable
{
   ...
   private long pk_CommunicationsNodeID;
...
public long getPk_CommunicationsNodeID()
{
   return pk_CommunicationsNodeID;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_CommunicationsNodeID(long pKeyName)
{
   this.pk_CommunicationsNodeID = pKeyName;
}

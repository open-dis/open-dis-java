 ...
 * Use as Type4OperationalParameter2.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public Type4OperationalParameter2 lookup[] = new Type4OperationalParameter2[1];

static private HashMap<Integer, Type4OperationalParameter2>enumerations = new HashMap<Integer, Type4OperationalParameter2>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    Type4OperationalParameter2 val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public Type4OperationalParameter2 getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    Type4OperationalParameter2 val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration Type4OperationalParameter2");
      return val;
}

 ...
 * Use as ExpendableAirCategory.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public ExpendableAirCategory lookup[] = new ExpendableAirCategory[7];

static private HashMap<Integer, ExpendableAirCategory>enumerations = new HashMap<Integer, ExpendableAirCategory>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    ExpendableAirCategory val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public ExpendableAirCategory getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    ExpendableAirCategory val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration ExpendableAirCategory");
      return val;
}

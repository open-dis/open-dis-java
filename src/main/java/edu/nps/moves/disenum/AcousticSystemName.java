 ...
 * Use as AcousticSystemName.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public AcousticSystemName lookup[] = new AcousticSystemName[10];

static private HashMap<Integer, AcousticSystemName>enumerations = new HashMap<Integer, AcousticSystemName>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    AcousticSystemName val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public AcousticSystemName getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    AcousticSystemName val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration AcousticSystemName");
      return val;
}

...
public class EntityStateUpdatePdu extends EntityInformationFamilyPdu implements Serializable {
     ...
     * algorithm used. This field shall be represented by a Linear Velocity
     ...
     * world and shall be represented by a World Coordinates record (see
     * 6.2.97).
     */
    protected Vector3Double entityLocation = new Vector3Double();

    /**
     * This field shall specify an entity’s orientation and shall be
     ...
     * attributes. This field shall be represented by an Entity Appearance
     * record (see 6.2.26).
     */

...
public class DatumSpecification extends Object implements Serializable
{
   ...
   private long pk_DatumSpecification;
...
public long getPk_DatumSpecification()
{
   return pk_DatumSpecification;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_DatumSpecification(long pKeyName)
{
   this.pk_DatumSpecification = pKeyName;
}

 ...
 * Use as TransmitState.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public TransmitState lookup[] = new TransmitState[3];

static private HashMap<Integer, TransmitState>enumerations = new HashMap<Integer, TransmitState>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    TransmitState val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public TransmitState getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    TransmitState val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration TransmitState");
      return val;
}

...
public long getPk_OneByteChunk()
{
   return pk_OneByteChunk;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_OneByteChunk(long pKeyName)
{
   this.pk_OneByteChunk = pKeyName;
}

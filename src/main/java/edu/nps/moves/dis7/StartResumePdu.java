...
public class StartResumePdu extends SimulationManagementFamilyPdu implements Serializable {
    ...
    /**
     * This field shall specify the real-world time (UTC) at which the entity is
     * to start/resume in the exercise. This information shall be used by the
     * participating simulation applications to start/resume an exercise
     * synchronously. This field shall be represented by a Clock Time record
     * (see 6.2.16).
     */
     ...
     * ahead of time by simulation management and is common to all participants
     * in a particular exercise. Simulation time may be either Absolute Time or
     * Relative Time. This field shall be represented by a Clock Time record
     * (see 6.2.16)
     */

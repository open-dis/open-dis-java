...
#
# Note: by default VBS2 runs on port 3000 with broadcast, so if you want to send
# to VBS2, set the network mode to bcast, select the appropriate bcast address,

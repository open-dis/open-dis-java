...
public long getPk_ProtocolMode()
{
   return pk_ProtocolMode;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_ProtocolMode(long pKeyName)
{
   this.pk_ProtocolMode = pKeyName;
}

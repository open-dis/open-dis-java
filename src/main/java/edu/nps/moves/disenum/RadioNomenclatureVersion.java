 ...
 * Use as RadioNomenclatureVersion.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public RadioNomenclatureVersion lookup[] = new RadioNomenclatureVersion[4];

static private HashMap<Integer, RadioNomenclatureVersion>enumerations = new HashMap<Integer, RadioNomenclatureVersion>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    RadioNomenclatureVersion val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public RadioNomenclatureVersion getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    RadioNomenclatureVersion val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration RadioNomenclatureVersion");
      return val;
}

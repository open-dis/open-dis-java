 ...
 * Use as DetailedModPulseMod.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public DetailedModPulseMod lookup[] = new DetailedModPulseMod[4];

static private HashMap<Integer, DetailedModPulseMod>enumerations = new HashMap<Integer, DetailedModPulseMod>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    DetailedModPulseMod val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public DetailedModPulseMod getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    DetailedModPulseMod val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration DetailedModPulseMod");
      return val;
}

...
public long getPk_ChangeOptions()
{
   return pk_ChangeOptions;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_ChangeOptions(long pKeyName)
{
   this.pk_ChangeOptions = pKeyName;
}

...
public class EightByteChunk extends Object implements Serializable
{
   ...
   private long pk_EightByteChunk;
...
public long getPk_EightByteChunk()
{
   return pk_EightByteChunk;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_EightByteChunk(long pKeyName)
{
   this.pk_EightByteChunk = pKeyName;
}

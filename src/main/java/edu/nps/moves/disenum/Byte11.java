 ...
 * Use as Byte11.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public Byte11 lookup[] = new Byte11[127];

static private HashMap<Integer, Byte11>enumerations = new HashMap<Integer, Byte11>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    Byte11 val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public Byte11 getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    Byte11 val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration Byte11");
      return val;
}

 ...
 * Use as AggregateState.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public AggregateState lookup[] = new AggregateState[6];

static private HashMap<Integer, AggregateState>enumerations = new HashMap<Integer, AggregateState>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    AggregateState val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public AggregateState getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    AggregateState val;

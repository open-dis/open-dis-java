 ...
 * Use as Optical.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public Optical lookup[] = new Optical[12];

static private HashMap<Integer, Optical>enumerations = new HashMap<Integer, Optical>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    Optical val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public Optical getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    Optical val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration Optical");
      return val;
}

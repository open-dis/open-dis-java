 ...
 * Use as DataRepresentation.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public DataRepresentation lookup[] = new DataRepresentation[3];

static private HashMap<Integer, DataRepresentation>enumerations = new HashMap<Integer, DataRepresentation>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    DataRepresentation val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public DataRepresentation getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    DataRepresentation val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration DataRepresentation");
      return val;
}

 ...
 * Use as MessageStart.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public MessageStart lookup[] = new MessageStart[2];

static private HashMap<Integer, MessageStart>enumerations = new HashMap<Integer, MessageStart>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    MessageStart val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public MessageStart getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    MessageStart val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration MessageStart");
      return val;
}

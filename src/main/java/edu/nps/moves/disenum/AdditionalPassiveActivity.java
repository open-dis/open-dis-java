 ...
 * Use as AdditionalPassiveActivity.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public AdditionalPassiveActivity lookup[] = new AdditionalPassiveActivity[32770];

static private HashMap<Integer, AdditionalPassiveActivity>enumerations = new HashMap<Integer, AdditionalPassiveActivity>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    AdditionalPassiveActivity val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public AdditionalPassiveActivity getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    AdditionalPassiveActivity val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration AdditionalPassiveActivity");
      return val;
}

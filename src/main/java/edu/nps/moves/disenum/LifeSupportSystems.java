...
public enum LifeSupportSystems 
{
    ...
    MISSING_DESCRIPTION(8070, "Missing Description");
 ...
 * Use as LifeSupportSystems.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public LifeSupportSystems lookup[] = new LifeSupportSystems[8071];

static private HashMap<Integer, LifeSupportSystems>enumerations = new HashMap<Integer, LifeSupportSystems>();

/* initialize the array and hash table at class load time */
static 
{
    for(LifeSupportSystems anEnum:LifeSupportSystems.values())
    {
...
/** Constructor */
LifeSupportSystems(int value, String description)
{
    this.value = value;
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    LifeSupportSystems val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public LifeSupportSystems getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    LifeSupportSystems val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration LifeSupportSystems");
      return val;
}

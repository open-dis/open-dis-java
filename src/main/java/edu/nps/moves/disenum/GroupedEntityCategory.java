 ...
 * Use as GroupedEntityCategory.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public GroupedEntityCategory lookup[] = new GroupedEntityCategory[10];

static private HashMap<Integer, GroupedEntityCategory>enumerations = new HashMap<Integer, GroupedEntityCategory>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    GroupedEntityCategory val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public GroupedEntityCategory getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    GroupedEntityCategory val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration GroupedEntityCategory");
      return val;
}

 ...
 * Use as DetailedModCarrierPhaseShift.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public DetailedModCarrierPhaseShift lookup[] = new DetailedModCarrierPhaseShift[1];

static private HashMap<Integer, DetailedModCarrierPhaseShift>enumerations = new HashMap<Integer, DetailedModCarrierPhaseShift>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    DetailedModCarrierPhaseShift val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public DetailedModCarrierPhaseShift getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    DetailedModCarrierPhaseShift val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration DetailedModCarrierPhaseShift");
      return val;
}

 ...
 * Use as ScanPattern.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public ScanPattern lookup[] = new ScanPattern[6];

static private HashMap<Integer, ScanPattern>enumerations = new HashMap<Integer, ScanPattern>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    ScanPattern val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public ScanPattern getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    ScanPattern val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration ScanPattern");
      return val;
}

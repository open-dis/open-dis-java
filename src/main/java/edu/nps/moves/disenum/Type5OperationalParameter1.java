 ...
 * Use as Type5OperationalParameter1.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public Type5OperationalParameter1 lookup[] = new Type5OperationalParameter1[1];

static private HashMap<Integer, Type5OperationalParameter1>enumerations = new HashMap<Integer, Type5OperationalParameter1>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    Type5OperationalParameter1 val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public Type5OperationalParameter1 getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    Type5OperationalParameter1 val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration Type5OperationalParameter1");
      return val;
}

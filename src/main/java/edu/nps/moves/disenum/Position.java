 ...
 * Use as Position.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public Position lookup[] = new Position[3];

static private HashMap<Integer, Position>enumerations = new HashMap<Integer, Position>();

/* initialize the array and hash table at class load time */
static 
{
    for(Position anEnum:Position.values())
    {
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    Position val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public Position getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    Position val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration Position");
      return val;
}

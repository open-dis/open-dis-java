 ...
 * Use as DigitChevronCode.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public DigitChevronCode lookup[] = new DigitChevronCode[127];

static private HashMap<Integer, DigitChevronCode>enumerations = new HashMap<Integer, DigitChevronCode>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    DigitChevronCode val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public DigitChevronCode getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    DigitChevronCode val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration DigitChevronCode");
      return val;
}

 ...
 * Use as RepairResponsePDU.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public RepairResponsePDU lookup[] = new RepairResponsePDU[5];

static private HashMap<Integer, RepairResponsePDU>enumerations = new HashMap<Integer, RepairResponsePDU>();

/* initialize the array and hash table at class load time */
static 
{
    for(RepairResponsePDU anEnum:RepairResponsePDU.values())
    {
...
/** Constructor */
RepairResponsePDU(int value, String description)
{
    this.value = value;
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    RepairResponsePDU val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public RepairResponsePDU getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    RepairResponsePDU val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration RepairResponsePDU");
      return val;
}

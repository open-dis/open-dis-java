 ...
 * Use as GermanWeaponsForLifeForms.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public GermanWeaponsForLifeForms lookup[] = new GermanWeaponsForLifeForms[10];

static private HashMap<Integer, GermanWeaponsForLifeForms>enumerations = new HashMap<Integer, GermanWeaponsForLifeForms>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    GermanWeaponsForLifeForms val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public GermanWeaponsForLifeForms getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    GermanWeaponsForLifeForms val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration GermanWeaponsForLifeForms");
      return val;
}

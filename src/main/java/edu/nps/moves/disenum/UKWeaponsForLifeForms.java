 ...
 * Use as UKWeaponsForLifeForms.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public UKWeaponsForLifeForms lookup[] = new UKWeaponsForLifeForms[13];

static private HashMap<Integer, UKWeaponsForLifeForms>enumerations = new HashMap<Integer, UKWeaponsForLifeForms>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    UKWeaponsForLifeForms val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public UKWeaponsForLifeForms getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    UKWeaponsForLifeForms val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration UKWeaponsForLifeForms");
      return val;
}

 ...
 * Use as ControlType.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public ControlType lookup[] = new ControlType[7];

static private HashMap<Integer, ControlType>enumerations = new HashMap<Integer, ControlType>();

/* initialize the array and hash table at class load time */
static 
{
    for(ControlType anEnum:ControlType.values())
    {
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    ControlType val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public ControlType getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    ControlType val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration ControlType");
      return val;
}

...
public class UnsignedIntegerWrapper extends Object implements Serializable
{
   ...
   private long pk_UnsignedIntegerWrapper;
...
public long getPk_UnsignedIntegerWrapper()
{
   return pk_UnsignedIntegerWrapper;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_UnsignedIntegerWrapper(long pKeyName)
{
   this.pk_UnsignedIntegerWrapper = pKeyName;
}

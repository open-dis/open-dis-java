 ...
 * Use as CommunicationType.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public CommunicationType lookup[] = new CommunicationType[6];

static private HashMap<Integer, CommunicationType>enumerations = new HashMap<Integer, CommunicationType>();

/* initialize the array and hash table at class load time */
static 
{
    for(CommunicationType anEnum:CommunicationType.values())
    {
...
/** Constructor */
CommunicationType(int value, String description)
{
    this.value = value;
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    CommunicationType val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public CommunicationType getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    CommunicationType val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration CommunicationType");
      return val;
}

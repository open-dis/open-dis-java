 ...
 * Use as ParameterTypeDesignator.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public ParameterTypeDesignator lookup[] = new ParameterTypeDesignator[2];

static private HashMap<Integer, ParameterTypeDesignator>enumerations = new HashMap<Integer, ParameterTypeDesignator>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    ParameterTypeDesignator val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public ParameterTypeDesignator getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    ParameterTypeDesignator val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration ParameterTypeDesignator");
      return val;
}

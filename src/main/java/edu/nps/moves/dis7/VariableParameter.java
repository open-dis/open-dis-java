...
public class VariableParameter extends Object implements Serializable {
  ...
  * The equals method doesn't always work--mostly it works only on classes that consist only of primitives. Be careful.
    ...
    public boolean equalsImpl(Object obj) {
        ...
        if (!(variableParameterFields1 == rhs.variableParameterFields1)) {
            ivarsEqual = false;
        }
        if (!(variableParameterFields2 == rhs.variableParameterFields2)) {
            ivarsEqual = false;
        }
        if (!(variableParameterFields3 == rhs.variableParameterFields3)) {
            ivarsEqual = false;
        }
        if (!(variableParameterFields4 == rhs.variableParameterFields4)) {
            ivarsEqual = false;
        }

 ...
 * Use as XmitTermSecMode.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public XmitTermSecMode lookup[] = new XmitTermSecMode[4];

static private HashMap<Integer, XmitTermSecMode>enumerations = new HashMap<Integer, XmitTermSecMode>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    XmitTermSecMode val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public XmitTermSecMode getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    XmitTermSecMode val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration XmitTermSecMode");
      return val;
}

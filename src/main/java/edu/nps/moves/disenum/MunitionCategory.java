 ...
 * Use as MunitionCategory.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public MunitionCategory lookup[] = new MunitionCategory[4];

static private HashMap<Integer, MunitionCategory>enumerations = new HashMap<Integer, MunitionCategory>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    MunitionCategory val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public MunitionCategory getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    MunitionCategory val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration MunitionCategory");
      return val;
}

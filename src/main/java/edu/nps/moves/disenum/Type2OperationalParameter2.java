 ...
 * Use as Type2OperationalParameter2.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public Type2OperationalParameter2 lookup[] = new Type2OperationalParameter2[1];

static private HashMap<Integer, Type2OperationalParameter2>enumerations = new HashMap<Integer, Type2OperationalParameter2>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    Type2OperationalParameter2 val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public Type2OperationalParameter2 getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    Type2OperationalParameter2 val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration Type2OperationalParameter2");
      return val;
}

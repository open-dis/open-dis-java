...
public class SimulationIdentifier extends Object implements Serializable
{
   ...
   private long pk_SimulationIdentifier;
...
public long getPk_SimulationIdentifier()
{
   return pk_SimulationIdentifier;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_SimulationIdentifier(long pKeyName)
{
   this.pk_SimulationIdentifier = pKeyName;
}

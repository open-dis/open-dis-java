...
/** Enumeration values for ModelType
 ...
 * Use as ModelType.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public ModelType lookup[] = new ModelType[1];

static private HashMap<Integer, ModelType>enumerations = new HashMap<Integer, ModelType>();
...
/** Constructor */
ModelType(int value, String description)
{
    this.value = value;
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    ModelType val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public ModelType getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    ModelType val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration ModelType");
      return val;
}

 ...
 * Use as Magnetic.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public Magnetic lookup[] = new Magnetic[4];

static private HashMap<Integer, Magnetic>enumerations = new HashMap<Integer, Magnetic>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    Magnetic val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public Magnetic getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    Magnetic val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration Magnetic");
      return val;
}

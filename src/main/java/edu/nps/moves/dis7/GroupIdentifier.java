...
public class GroupIdentifier extends Object implements Serializable
{
   ...
   private long pk_GroupIdentifier;
...
public long getPk_GroupIdentifier()
{
   return pk_GroupIdentifier;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_GroupIdentifier(long pKeyName)
{
   this.pk_GroupIdentifier = pKeyName;
}

...
public long getPk_EntityMarking()
{
   return pk_EntityMarking;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_EntityMarking(long pKeyName)
{
   this.pk_EntityMarking = pKeyName;
}

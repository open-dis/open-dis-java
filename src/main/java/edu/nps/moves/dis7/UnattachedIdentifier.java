...
public class UnattachedIdentifier extends Object implements Serializable
{
   ...
   private long pk_UnattachedIdentifier;
...
public long getPk_UnattachedIdentifier()
{
   return pk_UnattachedIdentifier;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_UnattachedIdentifier(long pKeyName)
{
   this.pk_UnattachedIdentifier = pKeyName;
}

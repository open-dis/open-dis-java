 ...
 * Use as Tanks.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public Tanks lookup[] = new Tanks[101];

static private HashMap<Integer, Tanks>enumerations = new HashMap<Integer, Tanks>();

/* initialize the array and hash table at class load time */
static 
{
    for(Tanks anEnum:Tanks.values())
    {
...
/** Constructor */
Tanks(int value, String description)
{
    this.value = value;
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    Tanks val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public Tanks getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    Tanks val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration Tanks");
      return val;
}

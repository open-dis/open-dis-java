...
public long getPk_NamedLocation()
{
   return pk_NamedLocation;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_NamedLocation(long pKeyName)
{
   this.pk_NamedLocation = pKeyName;
}

...
public class EnvironmentType extends Object implements Serializable
{
   ...
   private long pk_EnvironmentType;
...
public long getPk_EnvironmentType()
{
   return pk_EnvironmentType;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_EnvironmentType(long pKeyName)
{
   this.pk_EnvironmentType = pKeyName;
}

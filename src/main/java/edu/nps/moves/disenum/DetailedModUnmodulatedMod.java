 ...
 * Use as DetailedModUnmodulatedMod.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public DetailedModUnmodulatedMod lookup[] = new DetailedModUnmodulatedMod[2];

static private HashMap<Integer, DetailedModUnmodulatedMod>enumerations = new HashMap<Integer, DetailedModUnmodulatedMod>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    DetailedModUnmodulatedMod val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public DetailedModUnmodulatedMod getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    DetailedModUnmodulatedMod val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration DetailedModUnmodulatedMod");
      return val;
}

 ...
 * Use as GeneralRepairCode.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public GeneralRepairCode lookup[] = new GeneralRepairCode[2];

static private HashMap<Integer, GeneralRepairCode>enumerations = new HashMap<Integer, GeneralRepairCode>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    GeneralRepairCode val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public GeneralRepairCode getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    GeneralRepairCode val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration GeneralRepairCode");
      return val;
}

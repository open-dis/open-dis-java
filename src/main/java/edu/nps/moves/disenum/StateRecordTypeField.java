 ...
 * Use as StateRecordTypeField.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public StateRecordTypeField lookup[] = new StateRecordTypeField[260];

static private HashMap<Integer, StateRecordTypeField>enumerations = new HashMap<Integer, StateRecordTypeField>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    StateRecordTypeField val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public StateRecordTypeField getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    StateRecordTypeField val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration StateRecordTypeField");
      return val;
}

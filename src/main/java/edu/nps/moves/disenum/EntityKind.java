 ...
 * Use as EntityKind.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public EntityKind lookup[] = new EntityKind[10];

static private HashMap<Integer, EntityKind>enumerations = new HashMap<Integer, EntityKind>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    EntityKind val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public EntityKind getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    EntityKind val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration EntityKind");
      return val;
}

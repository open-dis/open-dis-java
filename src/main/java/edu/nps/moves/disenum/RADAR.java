 ...
 * Use as RADAR.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public RADAR lookup[] = new RADAR[6];

static private HashMap<Integer, RADAR>enumerations = new HashMap<Integer, RADAR>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    RADAR val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public RADAR getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    RADAR val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration RADAR");
      return val;
}

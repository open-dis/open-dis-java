 ...
 * Use as DetailedModAngleMod.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public DetailedModAngleMod lookup[] = new DetailedModAngleMod[4];

static private HashMap<Integer, DetailedModAngleMod>enumerations = new HashMap<Integer, DetailedModAngleMod>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    DetailedModAngleMod val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public DetailedModAngleMod getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    DetailedModAngleMod val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration DetailedModAngleMod");
      return val;
}

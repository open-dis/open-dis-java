...
/** Enumeration values for Specific
 ...
 * Use as Specific.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public Specific lookup[] = new Specific[2];

static private HashMap<Integer, Specific>enumerations = new HashMap<Integer, Specific>();

/* initialize the array and hash table at class load time */
static 
{
    for(Specific anEnum:Specific.values())
    {
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    Specific val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public Specific getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    Specific val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration Specific");
      return val;
}

 ...
 * Use as Reason.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public Reason lookup[] = new Reason[9];

static private HashMap<Integer, Reason>enumerations = new HashMap<Integer, Reason>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    Reason val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public Reason getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    Reason val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration Reason");
      return val;
}

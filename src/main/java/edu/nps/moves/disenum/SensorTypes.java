 ...
 * Use as SensorTypes.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public SensorTypes lookup[] = new SensorTypes[9];

static private HashMap<Integer, SensorTypes>enumerations = new HashMap<Integer, SensorTypes>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    SensorTypes val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public SensorTypes getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    SensorTypes val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration SensorTypes");
      return val;
}

 ...
 * Use as FLIR.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public FLIR lookup[] = new FLIR[10];

static private HashMap<Integer, FLIR>enumerations = new HashMap<Integer, FLIR>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    FLIR val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public FLIR getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    FLIR val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration FLIR");
      return val;
}

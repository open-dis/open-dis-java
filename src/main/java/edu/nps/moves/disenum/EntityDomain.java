 ...
 * Use as EntityDomain.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public EntityDomain lookup[] = new EntityDomain[6];

static private HashMap<Integer, EntityDomain>enumerations = new HashMap<Integer, EntityDomain>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    EntityDomain val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public EntityDomain getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    EntityDomain val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration EntityDomain");
      return val;
}

 ...
 * Use as ResponseFlag.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public ResponseFlag lookup[] = new ResponseFlag[3];

static private HashMap<Integer, ResponseFlag>enumerations = new HashMap<Integer, ResponseFlag>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    ResponseFlag val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public ResponseFlag getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    ResponseFlag val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration ResponseFlag");
      return val;
}

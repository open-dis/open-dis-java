 ...
 * Use as ClearChannel.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public ClearChannel lookup[] = new ClearChannel[2];

static private HashMap<Integer, ClearChannel>enumerations = new HashMap<Integer, ClearChannel>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    ClearChannel val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public ClearChannel getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    ClearChannel val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration ClearChannel");
      return val;
}

 ...
 * Use as FuelSystems.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public FuelSystems lookup[] = new FuelSystems[4032];

static private HashMap<Integer, FuelSystems>enumerations = new HashMap<Integer, FuelSystems>();

/* initialize the array and hash table at class load time */
static 
{
    for(FuelSystems anEnum:FuelSystems.values())
    {
...
/** Constructor */
FuelSystems(int value, String description)
{
    this.value = value;
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    FuelSystems val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public FuelSystems getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    FuelSystems val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration FuelSystems");
      return val;
}

...
public long getPk_Vector2Float()
{
   return pk_Vector2Float;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_Vector2Float(long pKeyName)
{
   this.pk_Vector2Float = pKeyName;
}

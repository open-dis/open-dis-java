 ...
 * Use as CompanyBatteryTroop.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public CompanyBatteryTroop lookup[] = new CompanyBatteryTroop[117];

static private HashMap<Integer, CompanyBatteryTroop>enumerations = new HashMap<Integer, CompanyBatteryTroop>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    CompanyBatteryTroop val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public CompanyBatteryTroop getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    CompanyBatteryTroop val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration CompanyBatteryTroop");
      return val;
}

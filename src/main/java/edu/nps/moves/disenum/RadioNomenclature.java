 ...
 * Use as RadioNomenclature.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public RadioNomenclature lookup[] = new RadioNomenclature[5];

static private HashMap<Integer, RadioNomenclature>enumerations = new HashMap<Integer, RadioNomenclature>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    RadioNomenclature val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public RadioNomenclature getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    RadioNomenclature val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration RadioNomenclature");
      return val;
}

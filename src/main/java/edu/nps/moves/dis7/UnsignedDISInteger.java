...
public class UnsignedDISInteger extends Object implements Serializable
{
   ...
   private long pk_UnsignedDISInteger;
...
public long getPk_UnsignedDISInteger()
{
   return pk_UnsignedDISInteger;
}

/** Hibernate primary key, not part of the DIS standard */
public void setPk_UnsignedDISInteger(long pKeyName)
{
   this.pk_UnsignedDISInteger = pKeyName;
}

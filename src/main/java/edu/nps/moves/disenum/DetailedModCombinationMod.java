 ...
 * Use as DetailedModCombinationMod.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public DetailedModCombinationMod lookup[] = new DetailedModCombinationMod[2];

static private HashMap<Integer, DetailedModCombinationMod>enumerations = new HashMap<Integer, DetailedModCombinationMod>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    DetailedModCombinationMod val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public DetailedModCombinationMod getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    DetailedModCombinationMod val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration DetailedModCombinationMod");
      return val;
}

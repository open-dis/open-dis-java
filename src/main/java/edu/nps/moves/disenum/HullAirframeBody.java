 ...
 * Use as HullAirframeBody.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public HullAirframeBody lookup[] = new HullAirframeBody[1061];

static private HashMap<Integer, HullAirframeBody>enumerations = new HashMap<Integer, HullAirframeBody>();

/* initialize the array and hash table at class load time */
static 
{
    for(HullAirframeBody anEnum:HullAirframeBody.values())
    {
...
/** Constructor */
HullAirframeBody(int value, String description)
{
    this.value = value;
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    HullAirframeBody val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public HullAirframeBody getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    HullAirframeBody val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration HullAirframeBody");
      return val;
}

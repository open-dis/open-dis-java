 ...
 * Use as StateChangeUpdateIndicator.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public StateChangeUpdateIndicator lookup[] = new StateChangeUpdateIndicator[2];

static private HashMap<Integer, StateChangeUpdateIndicator>enumerations = new HashMap<Integer, StateChangeUpdateIndicator>();
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    StateChangeUpdateIndicator val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public StateChangeUpdateIndicator getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    StateChangeUpdateIndicator val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration StateChangeUpdateIndicator");
      return val;
}

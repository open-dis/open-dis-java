...
/** Enumeration values for Physical
 ...
 * Use as Physical.lookup[aVal] to get the enumeration that corresponds to a value.<p>
 * In non-realtime environments, the prefered method is getEnumerationForValue().
 */
static public Physical lookup[] = new Physical[3];

static private HashMap<Integer, Physical>enumerations = new HashMap<Integer, Physical>();

/* initialize the array and hash table at class load time */
static 
{
    for(Physical anEnum:Physical.values())
    {
...
/** Constructor */
Physical(int value, String description)
{
    this.value = value;
...
static public String getDescriptionForValue(int aVal)
{
  String desc;
    ...
    Physical val = enumerations.get(new Integer(aVal));
      if(val == null)
...
*/
static public Physical getEnumerationForValue(int aVal) throws EnumNotFoundException
{
    Physical val;
      val = enumerations.get(new Integer(aVal));
      if(val == null)
         throw new EnumNotFoundException("no enumeration found for value " + aVal + " of enumeration Physical");
      return val;
}
